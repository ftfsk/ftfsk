const portfolioItems = [
  {
    ...
    description_en: 'High-quality video and photography for clients who want to stand out in the real estate market. Content for AirBNB, Instagram Reels, TikTok and YouTube.',
    imageFile: 'real-estate.jpg',
    imageUrl: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=80'
  },
  {
    title: 'Social Media Promotions',
    title_en: 'Social Media Promotions',
    description: 'Δυναμικά βίντεο που κόβουν την ανάσα. Ιδανικά για αυτούς που θέλουν να διαφημίσον την επιχείρησή τους.',
    description_en: 'Dynamic, attention-grabbing videos ideal for promoting your business on social platforms.',
  ...
  },
  {
    ...
    description_en: 'We create 3D models and 2D maps using drones. Ideal for construction firms and agricultural businesses.',
  ...
  },
  {
    ...
    title_en: 'Construction Progress Documentation',
    ...
    description_en: 'Services for field engineers and construction companies who want to monitor project progress and update clients with modern reporting methods.',
